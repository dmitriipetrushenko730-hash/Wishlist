...
const userDefaultLanguages = {
    "Дима": "ru", "Лера": "ru", "Сергей": "ru", "Катя": "de", "Елена": "en"
};

const translations = {
    ru: {
        loginTitle: "Кто ты?", welcome: "Здравствуйте, ", btnEdit: "Редактировать вишлист", btnView: "Просмотр вишлистов", btnLogout: "Сменить пользователя",
        langLabel: "Язык:", langTxt: "Русский", flag: "🇷🇺", myListTitle: "Мой вишлист", placeholder: "напиши своё пожелание", btnAdd: "Добавить",
        btnBack: "Назад в меню", viewSelectionTitle: "Чей вишлист посмотреть?", friendListTitle: "Вишлист: ", btnBackSel: "Назад к выбору",
        btnEditItem: "Ред.", btnDelItem: "Удалить", reserved: "🔒 Забронировано: ", fulfills: "🔒 Исполняет: ", alertReserved: "Этот подарок уже забронировал(а) ", promptEdit: "Отредактируйте ваше пожелание:"
    },
    en: {
        loginTitle: "Who are you?", welcome: "Hello, ", btnEdit: "Edit wishlist", btnView: "View wishlists", btnLogout: "Change user",
        langLabel: "Language:", langTxt: "English", flag: "🇺🇸", myListTitle: "My wishlist", placeholder: "write your wish here", btnAdd: "Add",
        btnBack: "Back to menu", viewSelectionTitle: "Whose wishlist to view?", friendListTitle: "Wishlist: ", btnBackSel: "Back to selection",
        btnEditItem: "Edit", btnDelItem: "Delete", reserved: "🔒 Reserved by: ", fulfills: "🔒 Fulfills: ", alertReserved: "This gift has already been reserved by ", promptEdit: "Edit your wish:"
    },
    de: {
        loginTitle: "Wer bist du?", welcome: "Hallo, ", btnEdit: "Wunschliste bearbeiten", btnView: "Wunschlisten anzeigen", btnLogout: "Benutzer wechseln",
        langLabel: "Sprache:", langTxt: "Deutsch", flag: "🇩🇪", myListTitle: "Meine Wunschliste", placeholder: "Schreib deinen Wunsch", btnAdd: "Hinzufügen",
        btnBack: "Zurück zum Menü", viewSelectionTitle: "Wessen Wunschliste anzeigen?", friendListTitle: "Wunschliste: ", btnBackSel: "Zurück zur Auswahl",
        btnEditItem: "Bearb.", btnDelItem: "Löschen", reserved: "🔒 Reserviert von: ", fulfills: "🔒 Erfüllt von: ", alertReserved: "Dieses Geschenk wurde bereits reserviert von ", promptEdit: "Bearbeite deinen Wunsch:"
    }
};

// Создание кнопок пользователей
...
function logout() {
    ...
    document.getElementById('login-title').innerText = translations['ru'].loginTitle;
...
function openMyWishlist() { showScreen('screen-my-list'); renderMyWishes(); }
...
function addWish() {
    ...
    if (!localData[currentUser]) localData[currentUser] = {};
    
    localData[currentUser][newId] = { id: newId, text: text, checked: false, checkedBy: null };
...
function editWish(id, oldText) {
    ...
    if (newText !== null && newText.trim() !== "") {
        let localData = JSON.parse(localStorage.getItem('local_wishlists')) || {};
        if (localData[currentUser] && localData[currentUser][id]) {
